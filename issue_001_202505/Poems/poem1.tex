...
\poemtitle{Sonnet: The Story Because of You}

\poemauthorcenter{xxx} % Centered author

\settowidth{\versewidth}{the soul it has would bless me forever. } % Insert one of the average-sized verses, used for centering the poem
